          ...
          <div className="card shadow-sm">
              ...
              <div className="card-body border-bottom">
                <div className="row align-items-center">
                  <div className="col-md-3 mb-2">
                    ...
                    >
                      <option value="live" className="text-uppercase">Live Data</option>
                      <option value="backup" className="text-uppercase">Backup Data</option>
                      <option value="olddata" className="text-uppercase">Old Data</option>
                    </select>
                  </div>
            ...
            <div className="card-body">
              ...
              {state.loading ? (
                ...
                <ReusableTable
                  ...
                  key={`level-${state.currentLevel}-${state.parentData?.sportName || state.dataType}-${state.dateRange.from}-${state.dateRange.to}-${state.tableRefreshKey}`}
                />
              )}
            </div>
            ...
            <div className="card-footer text-muted">
              {state.currentLevel === 2
                ...
                : `Showing ${state.dataType} data ${state.dateRange.from &&
                    state.dateRange.to &&
